...
g++ gpu_count.cpp -o gpu_count -std=c++17 -I /opt/libtorch/include -I /opt/libtorch/include/torch/csrc/api/include -L /opt/libtorch/lib -ltorch -lc10 -lcuda -ldl -lpthread -lnvrtc
